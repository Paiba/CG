...
void idle(void){
	...
	&& distanciaArena(JOGADOR.pos_x,JOGADOR.pos_y-VelFin))
		if(keyStatus['a']||keyStatus['A']||keyStatus['s']||keyStatus['S']||keyStatus['d']||keyStatus['D'] 
		&& distanciaAereo(JOGADOR.pos_x,JOGADOR.pos_y-VelFin/sqrt(2)) && distanciaArena(JOGADOR.pos_x,JOGADOR.pos_y-VelFin/sqrt(2)))
		{
    		JOGADOR.pos_y-= VelFin/sqrt(2);
		}
		else{
			JOGADOR.pos_y-= VelFin;
		}

  	if((keyStatus['a'] || keyStatus['A']) && decolado && distanciaAereo(JOGADOR.pos_x-VelFin,JOGADOR.pos_y)
	&& distanciaArena(JOGADOR.pos_x - VelFin,JOGADOR.pos_y))
    	if(keyStatus['w']||keyStatus['W']||keyStatus['s']||keyStatus['S']||keyStatus['d']||keyStatus['D']
		&& distanciaAereo(JOGADOR.pos_x-VelFin/sqrt(2),JOGADOR.pos_y) && distanciaArena(JOGADOR.pos_x-VelFin/sqrt(2),JOGADOR.pos_y))
		{
    		JOGADOR.pos_x-= VelFin/sqrt(2);
		}
		else{
  	...
  	if((keyStatus['s'] || keyStatus['S']) && decolado 
		...
		&& distanciaArena(JOGADOR.pos_x, JOGADOR.pos_y+VelFin))
    	if(keyStatus['w']||keyStatus['W']||keyStatus['a']||keyStatus['A']||keyStatus['d']||keyStatus['D']
		&& distanciaAereo(JOGADOR.pos_x, JOGADOR.pos_y+VelFin/sqrt(2)) 
		&& distanciaArena(JOGADOR.pos_x, JOGADOR.pos_y+VelFin/sqrt(2)))
		{
    		JOGADOR.pos_y+= VelFin/sqrt(2);
		}
		else{
  	...
  	if((keyStatus['d'] || keyStatus['D']) && decolado 
		&& distanciaAereo(JOGADOR.pos_x+ VelFin/sqrt(2),JOGADOR.pos_y) 
		&& distanciaArena(JOGADOR.pos_x+ VelFin/sqrt(2),JOGADOR.pos_y))
    	if(keyStatus['w']||keyStatus['W']||keyStatus['a']||keyStatus['A']||keyStatus['s']||keyStatus['S']
